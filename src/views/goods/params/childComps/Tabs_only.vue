  ...
  <div class="static">
    ...
    <el-table 
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button @click="editOnly(scope.row)" type="primary" icon="el-icon-edit" size="mini">编辑</el-button>
          <el-button @click="deleteOnly(scope.row)" type="danger" icon="el-icon-delete" size="mini">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    clickAdd() {
      this.$refs.onlyAddRef.isShow = !this.$refs.onlyAddRef.isShow
    },
    editOnly(rowData) {
      this.$refs.onlyEditRef.isShow = !this.$refs.onlyEditRef.isShow
      this.$refs.onlyEditRef.rowData = rowData
    },
    deleteOnly(rowData) {
